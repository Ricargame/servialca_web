...
$Pdf->SetFont('Arial', 'B', 10);
$Pdf->Cell(102, 80, "" . strtoupper(utf8_decode($datos[0]["titular_nombre"] . " " . $datos[0]["titular_apellido"])));
$Pdf->SetFont('Arial', 'B', 10);
...
$Pdf->Ln(5);
$Pdf->SetFont('Arial', 'B', 10);
$Pdf->Cell(22, 80, "Contratante: " . strtoupper(utf8_decode($datos[0]["cliente_nombre"])) . "  " . strtoupper(utf8_decode($datos[0]["cliente_apellido"])));
$Pdf->SetFont('Arial', '', 10);
$Pdf->Cell(94, 80, "");
$Pdf->SetFont('Arial', 'B', 10);
$Pdf->Cell(13, 80, "CI/RIF: ");
...
$Pdf->SetFont('Arial', '', 10);
$Pdf->Cell(88, 80, "" . utf8_decode($datos[0]["color_nombre"]));
$Pdf->SetFont('Arial', 'B', 10);
